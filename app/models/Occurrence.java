...
public class Occurrence extends Model {
	...
	public boolean inBoundingBoxList(Float decimalLatitude, Float decimalLongitude) {
		ArrayList<Float[]> BoundingBoxesList = new ArrayList<Float[]>();
		BoundingBoxesList.add(new Float[] {(float) 41.333740, (float) 51.089062, (float) -5.140600, (float) 9.559320}); //France
		BoundingBoxesList.add(new Float[] {(float) 14.96712, (float) 16.53148, (float) -61.82977, (float) -60.98185}); //Guadeloupe
		BoundingBoxesList.add(new Float[] {(float) 13.93564, (float) 14.382440, (float) -61.23976, (float) -60.799}); //Martinique
		BoundingBoxesList.add(new Float[] {(float) 1.10326, (float) 5.84561, (float) -54.67087, (float)-51.54721}); //Guyane
		BoundingBoxesList.add(new Float[] {(float) -13.5459, (float)-12.5479, (float) 44.9371, (float) 45.3745}); //Mayotte
		BoundingBoxesList.add(new Float[] {(float) -22.05384, (float)-20.85875, (float) 55.20124, (float) 55.85227}); //Reunion
		BoundingBoxesList.add(new Float[] {(float) -16.55408, (float) -13.15017, (float) -178.2342, (float) -176.072}); //Wallis&Futuna
		BoundingBoxesList.add(new Float[] {(float) -27.63533, (float) -19.44487, (float) 163.45591, (float) 168.2484}); //Nouvelle-Calédonie
		BoundingBoxesList.add(new Float[] {(float) 49.48878, (float) 78.287, (float) -79.12063, (float) -37.50438}); //TAAF
		BoundingBoxesList.add(new Float[] {(float) 46.43198, (float) 47.15415, (float) -56.41318, (float) -56.10561}); //Saint-Pierre et Miquelon
		BoundingBoxesList.add(new Float[] {(float) -27.653570, (float) 10.359830, (float) -154.700485, (float) -108.872910}); //Polynesie
